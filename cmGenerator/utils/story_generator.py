...
def generate_club_history_prompt(randomClub: str) -> str:
    ...
    Please provie me with the following information about {randomClub} in an acceptable HTML format with the according tags.:

    <h4> **Club Backstory**: </h4>
    <p>- Write an in-depth backstory of the club in a paragraph no longer than 10 sentences.
       - Include at least 5 sentences about their 2 biggest rivals.
       - Make it sound like a historian wrote it. </p>

    <h4> **League History**: </h4>
    <p>- Write a paragraph about the history of the league {randomClub} is in.
       - Focus on the 4 most successful clubs and the 5 biggest rivalries, explaining why they are rivals.
       - Ensure it is no less than 6 sentences and sounds like a historian wrote it. </p>
    ...
    <p>- Write a paragraph about {randomClub}'s influence on soccer.
